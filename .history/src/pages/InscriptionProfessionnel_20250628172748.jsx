...
const InscriptionProfessionnel = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Optional : redirection après un délai
        ...
        <div className="w-full max-w-xl bg-white rounded-3xl shadow-lg p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-7" encType="multipart/form-data" noValidate>
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                className="w-44 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-base rounded-2xl shadow-md transition duration-300 ease-in-out focus:outline-none focus:ring-3 focus:ring-indigo-400"
              >
                S'inscrire
              </button>
            </div>
