            ...
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Vous avez accès à la gestion des utilisateurs, professionnels, fonctionnalités de la plateforme et modération des messages.
                </p>
              </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="bg-blue-100 p-4 rounded-md text-blue-800 font-semibold shadow-sm">
                👤 Total Utilisateurs: <span className="font-bold">500</span>
              </div>
              <div className="bg-green-100 p-4 rounded-md text-green-800 font-semibold shadow-sm">
                📚 Ressources Publiées: <span className="font-bold">120</span>
              </div>
              <div className="bg-yellow-100 p-4 rounded-md text-yellow-800 font-semibold shadow-sm">
                💬 Discussions Actives: <span className="font-bold">45</span>
              </div>
            </div>
          </div>
        );
