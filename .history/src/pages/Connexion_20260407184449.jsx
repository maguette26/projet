...
const Connexion = () => {
  ...
  // Animation des cercles (flottement + glassy)
  useEffect(() => {
    let frame;
    const animate = () => {
      ...
      <div className="flex min-h-screen bg-gray-50">
        ...
        <div className="hidden md:flex w-1/2 items-center justify-center rounded-l-3xl overflow-hidden relative bg-gradient-to-tr from-blue-100 via-blue-200 to-blue-300">
          <svg className="absolute w-full h-full" viewBox="0 0 800 600" xmlns="http://www.w3.org/2000/svg">
            <circle cx={200 + offsets.circle1.x} cy={200 + offsets.circle1.y} r="120" fill="#93c5fd" fillOpacity="0.6" filter="url(#blur)" />
            <circle cx={600 + offsets.circle2.x} cy={400 + offsets.circle2.y} r="150" fill="#60a5fa" fillOpacity="0.5" filter="url(#blur)" />
            <circle cx={400 + offsets.circle3.x} cy={300 + offsets.circle3.y} r="180" fill="#3b82f6" fillOpacity="0.4" filter="url(#blur)" />
            <filter id="blur">
