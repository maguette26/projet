    ...
    <Layout>
      <div className="flex min-h-screen bg-gray-50">
        ...
        <div className="flex w-full md:w-1/2 items-center justify-center p-10">
          <div className="w-full max-w-md bg-white backdrop-blur-md rounded-3xl shadow-2xl p-10">
            ...
            <form onSubmit={handleConnexion} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="mt-2 block w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-blue-500 focus:border-blue-500 shadow-sm transition duration-300"
                />
              </div>
              <div>
