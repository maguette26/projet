        ...
        return (
          <div className="p-6 bg-white rounded-lg shadow max-w-4xl mx-auto">
            <h2 className="text-3xl font-semibold text-gray-800 mb-6 flex items-center gap-3">
              Bonjour, <span className="text-indigo-700">{adminName}</span> <Smile className="w-7 h-7 text-yellow-400" />
              
            </h2>

            {currentAdminEmail && currentAdminRole && (
              <p className="mb-4 text-gray-700">
                Connecté en tant que : <strong>{currentAdminEmail}</strong> (Rôle : <span className="font-semibold">{currentAdminRole}</span>)
              </p>
            )}

            <p className="mb-6 text-gray-700 text-lg leading-relaxed">
              Bienvenue sur votre tableau de bord PsyConnect. Vous avez accès à l'ensemble des outils nécessaires pour assurer la gestion efficace de la plateforme.
              <br /><br />
              Vous pouvez gérer les utilisateurs standards, les professionnels de santé mentale, modérer les discussions, et configurer les fonctionnalités disponibles. Utilisez le menu latéral pour naviguer facilement entre ces sections.
              <br /><br />
              N'oubliez pas de vérifier régulièrement les messages et notifications pour rester informé des dernières activités.
            </p>
          </div>
        );
