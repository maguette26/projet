...
const TableauAdmin = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      `}
      >
        {/* Header avec emoji et bouton toggle */}
        <div className="flex items-center justify-between p-6 border-b border-blue-700">
          <div className="flex items-center gap-2">
            <span className="text-2xl select-none" role="img" aria-label="cerveau">🧠</span>
            {sidebarOpen && (
              <h1 className="text-2xl font-bold whitespace-nowrap">
                PsyConnect <span className="font-light">Admin</span>
              </h1>
            )}
          </div>
            ...
            {menuItems.map(({ key, label, icon }) => (
              <li key={key} className="mb-2">
                <button
                  ...
                  className={`w-full text-left px-6 py-3 flex items-center transition-colors duration-200 whitespace-nowrap
