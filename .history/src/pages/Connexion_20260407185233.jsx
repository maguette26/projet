...
const Connexion = () => {
  ...
  // Animation flottante pour les cercles SVG
  useEffect(() => {
    let frame;
    const animate = () => {
      ...
      <div className="flex min-h-screen bg-gray-50">
        ...
        <div className="hidden md:flex w-1/2 items-center justify-center rounded-l-3xl overflow-hidden relative bg-gradient-to-tr from-blue-100 via-blue-200 to-blue-300">
          <svg className="absolute w-full h-full" viewBox="0 0 800 600" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Filtres flou pour glass effect */}
        ...
        <div className="flex w-full md:w-1/2 items-center justify-center p-10">
          <div className="w-full max-w-sm bg-white/90 backdrop-blur-md rounded-3xl shadow-xl p-10 transform opacity-0 translate-y-6 animate-fadeInUp">
            ...
            <form onSubmit={handleConnexion} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="mt-2 block w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm transition duration-300 transform hover:scale-[1.02]"
                />
              </div>
              <div>
