...
const TableauAdmin = () => {
  ...
  useEffect(() => {
    // Récupère le prénom + nom concaténés depuis localStorage, ou juste 'Admin'
        ...
        return (
          <div className="p-6 bg-white rounded-lg shadow max-w-4xl mx-auto">
            <h2 className="text-3xl font-semibold text-gray-800 mb-4 flex items-center gap-2">
              Bonjour, <span className="text-indigo-700">{adminName}</span> <Smile className="w-6 h-6 text-yellow-400" />
            </h2>
            <p className="mb-6 text-gray-700 text-lg leading-relaxed">
              Bienvenue dans votre tableau de bord. Ici, vous pouvez gérer les utilisateurs, les professionnels, modérer les discussions,
              et configurer les fonctionnalités de la plateforme via le menu latéral.
            </p>
          </div>
        );
