...
const Forum = () => {
    ...
    const handleSubmitReponse = async (e) => {
        ...
        try {
            ...
            setErrorReponses(err.response?.data?.message || "Erreur lors de l'envoi de la réponse,certains mots utilisés ne sont pas autorisés dans la création du sujet. Veuillez reformuler.");
        }
    };
