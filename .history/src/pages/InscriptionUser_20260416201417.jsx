        ...
        <div className="flex w-full md:w-1/2 items-center justify-center px-4 py-12">
          ...
          <div className="w-full max-w-md bg-white rounded-3xl shadow-xl p-10">
            ...
            >
              ...
              {/* NOM */}
              <input name="nom" value={formData.nom} onChange={handleChange} autoComplete="off" />

              {/* PRENOM */}
              <input name="prenom" value={formData.prenom} onChange={handleChange} autoComplete="off" />

              {/* EMAIL */}
              <input name="email" value={formData.email} onChange={handleChange} autoComplete="off" />

              {/* TELEPHONE */}
              <input name="telephone" value={formData.telephone} onChange={handleChange} autoComplete="off" />
              ...
              <button type="submit" className="w-full py-3 bg-indigo-600 text-white rounded-xl">
                S'inscrire
              </button>
            ...
            <p className="text-center text-sm mt-4">
              Déjà un compte ? <Link to="/connexion">Connexion</Link>
            </p>
