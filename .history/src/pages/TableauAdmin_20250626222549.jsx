...
import { Smile, Settings, Users, UserCheck, MessageSquare, UserMedical } from 'lucide-react';
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-blue-800 text-white flex flex-col h-full shadow-lg">
        <div className="p-6 text-center text-2xl font-bold border-b border-blue-700 flex items-center justify-center gap-2">
          <span className="text-blue-200 flex items-center gap-1">
            <UserMedical className="w-7 h-7 text-green-400" />
            PsyConnect
          </span>
