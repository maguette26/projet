  ...
  return (
    <Layout>
      <div className="flex min-h-screen max-w-7xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
        {/* Navbar verticale */}
        <nav className="w-64 bg-indigo-600 text-indigo-50 flex flex-col">
          <div className="flex items-center justify-center h-20 border-b border-indigo-500">
            <h1 className="text-2xl font-bold">PsyConnect</h1>
          </div>

          <div className="flex-grow flex flex-col space-y-2 px-4 mt-6">
            <button
          ...
          {/* Photo & nom utilisateur en bas */}
          <div className="px-4 py-4 border-t border-indigo-500 flex items-center gap-3">
            ...
            <span className="font-semibold truncate">{currentUser.prenom} {currentUser.nom}</span>
          </div>
        </nav>
