...
const TableauUtilisateur = () => {
  ...
  // Suppression du modal, donc on enlève ces états et fonctions liées au modal
  ...
  // Suppression de la fonction handleShowConfirmModal puisqu'on supprime le modal
  ...
  return (
    <Layout>
      <div className="flex min-h-screen max-w-7xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
        {/* Navbar verticale (identique à l’original) */}
