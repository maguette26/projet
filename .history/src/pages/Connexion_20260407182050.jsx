...
const Connexion = () => {
  ...
  return (
    <Layout>
      <div className="flex min-h-screen bg-gradient-to-br from-blue-50 via-pink-50 to-yellow-50">
        ...
        <div className="flex w-full md:w-1/2 items-center justify-center p-10">
          <div className="w-full max-w-md bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl p-8">
            ...
            <form onSubmit={handleConnexion} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-pink-400 focus:border-pink-400 shadow-sm transition duration-300"
                />
              </div>
              <div>
              ...
              <button
                type="submit"
                className="w-full py-3 bg-pink-400 hover:bg-pink-500 text-white font-semibold rounded-xl shadow-md transition transform hover:scale-105"
              >
                Se connecter
              </button>
            ...
            <p className="text-center text-sm text-gray-600 mt-6">
              ...
              <Link to="/inscription" className="ml-1 text-pink-400 font-semibold hover:underline">Créer un compte</Link>
            </p>
          </div>
        </div>
      </div>
