        ...
        return (
          <div className="p-4">
            {consultationsError ? (
              ...
              <p className="text-gray-600 dark:text-gray-300">Aucune consultation.</p>
            ) : (
              <table className="min-w-full mt-4 bg-white dark:bg-gray-800 shadow rounded">
                <thead className="bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 text-left text-sm">
                  <tr>
                ...
                <tbody className="text-sm text-gray-700 dark:text-gray-300">
                  {consultationsPassees.map(con => (
                    <tr key={con.idConsultation} className="hover:bg-blue-50 dark:hover:bg-blue-800">
