  ...
  return (
    <Layout>
      <div className="flex min-h-screen bg-gray-50">
        {/* Sidebar */}
        <nav
          className={`flex flex-col bg-gradient-to-b from-blue-800 to-blue-600 text-white shadow-lg
        ...
        >
          ...
          <div className="flex items-center gap-3 p-4 border-b border-blue-500">
            {currentUser?.photoUrl ? (
              <img src={currentUser.photoUrl} alt="user" className="w-12 h-12 rounded-full" />
            ) : (
            ...
            {!sidebarReduced && (
              <div className="flex flex-col">
                ...
                <span className="text-blue-300 text-sm">Utilisateur</span>
              </div>
            )}
          </div>

          {/* Navigation items */}
          <div className="flex-grow mt-4 space-y-1 px-2">
            <NavItem
