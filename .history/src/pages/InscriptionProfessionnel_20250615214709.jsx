...
const InputField = ({ id, label, type = 'text', autoComplete, value, onChange, error, placeholder }) => (
  <div className="flex flex-col">
    ...
    <input
      ...
      className={`border rounded-xl px-5 py-3 text-gray-900 text-lg placeholder-gray-400 focus:outline-none focus:ring-4 transition
...
const InscriptionProfessionnel = () => {
  ...
  // Validation mot de passe, même fonction que pour utilisateur (tu peux extraire ça dans un helper)
  ...
  // Gestion fichier justificatif (upload)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // On utilise FormData pour envoyer fichier + champs
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-100 to-white px-6 py-16">
        <div className="w-full max-w-xl bg-white rounded-3xl shadow-2xl p-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-8" encType="multipart/form-data">
            ...
            <div className="flex flex-col">
              <label htmlFor="justificatif" className="mb-2 text-gray-800 font-semibold text-lg">
