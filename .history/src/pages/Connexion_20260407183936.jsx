...
const Connexion = () => {
  ...
  // Animation subtile des cercles (flottement horizontal + vertical)
  useEffect(() => {
    let frame;
    const animate = () => {
      ...
      <div className="flex min-h-screen bg-gray-50">
        ...
        <div className="hidden md:flex w-1/2 items-center justify-center rounded-l-3xl overflow-hidden relative bg-gradient-to-tr from-indigo-300 via-purple-200 to-pink-100">
          <svg className="absolute w-full h-full" viewBox="0 0 800 600" xmlns="http://www.w3.org/2000/svg">
            <circle cx={200 + offsets.circle1.x} cy={200 + offsets.circle1.y} r="120" fill="#a78bfa" />
            <circle cx={600 + offsets.circle2.x} cy={400 + offsets.circle2.y} r="150" fill="#c4b5fd" />
            <circle cx={400 + offsets.circle3.x} cy={300 + offsets.circle3.y} r="180" fill="#e9d5ff" />
          </svg>
