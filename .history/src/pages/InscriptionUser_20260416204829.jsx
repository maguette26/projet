        ...
        <div className="flex w-full md:w-1/2 items-center justify-center px-4 py-12">
          <div className="w-full max-w-md bg-white rounded-3xl shadow-xl p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {[
                { id: 'nom', label: 'Nom', type: 'text', autoComplete: 'off' },
                { id: 'prenom', label: 'Prénom', type: 'text', autoComplete: 'off' },
                { id: 'email', label: 'Adresse email', type: 'email', autoComplete: 'off' },
                { id: 'telephone', label: 'Téléphone', type: 'tel', autoComplete: 'off' },
                { id: 'motDePasse', label: 'Mot de passe', type: 'password', autoComplete: 'off' },
                { id: 'confirmerMotDePasse', label: 'Confirmer le mot de passe', type: 'passord', autoComplete: 'new-password' },
