...
const Forum = () => {
    ...
    const handleSubmitReponse = async (e) => {
        ...
        try {
            ...
            // Mise à jour du compteur de réponses dans la liste des sujets
            setSujets(prev => prev.map(sujet => 
                sujet.id === selectedTopic.id 
                    ? { ...sujet, reponsesCount: (sujet.reponsesCount || 0) + 1 }
                    : sujet
            ));
        } catch (err) {
    ...
    const handleUpdateSujet = async (e) => {
        ...
        try {
            ...
            if (selectedTopic?.id === editingSujetId) {
                setSelectedTopic(prev => ({
                    ...prev,
                    titre: editingSujetTitre,
                    contenu: editingSujetContenu
                }));
            }
                                                ...
                                                {editingReponseId === reponse.id ? (
                                                    <form onSubmit={handleUpdateReponse} className="p-4">
                                                        ...
                                                        <div className="mt-2 flex justify-end space-x-2">
                                                            ...
                                                            <button
                                                                type="submit"
                                                                className="px-3 py-1 text-indigo-600 border border-indigo-600 rounded-lg hover:bg-indigo-50 transition-colors text-sm"
                                                            >
                                                                Enregistrer
                                                            </button>
                                                        </div>
                                ...
                                <div className="bg-white rounded-lg border border-gray-200 p-6">
                                    ...
                                    {!isAuthenticated ? (
                                        <div className="border border-blue-200 rounded-lg p-4 text-center">
                                            ...
                                            <a 
                                                href="/connexion" 
                                                className="inline-flex items-center px-4 py-2 text-indigo-600 border border-indigo-600 rounded-lg hover:bg-indigo-50 transition-colors"
                                            >
                                        ...
                                        <form onSubmit={handleSubmitReponse} className="space-y-4">
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <button
                                                    type="submit"
                                                    className="inline-flex items-center px-4 py-2 text-indigo-600 border border-indigo-600 rounded-lg hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                                >
