  ...
  return (
    <Layout>
      <div className="flex min-h-screen bg-gray-50">
        ...
        <div className="hidden md:flex w-1/2 items-center justify-center rounded-l-3xl overflow-hidden bg-gray-100 relative">
          {/* Illustration SVG simple monochrome */}
          <svg className="absolute w-full h-full" viewBox="0 0 800 600" xmlns="http://www.w3.org/2000/svg">
            <circle cx="200" cy="200" r="120" fill="#e0e7ff" />
            <circle cx="600" cy="400" r="150" fill="#c7d2fe" />
            <circle cx="400" cy="300" r="180" fill="#e0e7ff" />
          </svg>
        ...
        <div className="flex w-full md:w-1/2 items-center justify-center p-10">
          <div className="w-full max-w-md bg-white/90 backdrop-blur-md rounded-3xl shadow-lg p-8">
