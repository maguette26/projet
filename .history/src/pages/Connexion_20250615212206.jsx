    ...
    <Layout>
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-300 via-white to-indigo-100 relative overflow-hidden">
        ...
        <motion.div
          ...
          className="relative z-10 w-full max-w-4xl bg-white/80 rounded-3xl shadow-2xl border border-gray-200 p-12 md:p-16 flex flex-col justify-center"
        >
          ...
          <form onSubmit={handleConnexion} className="space-y-6 max-w-xl mx-auto w-full">
            ...
            <button
              type="submit"
              className="w-1/2 mx-auto py-2 px-4 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 font-medium transition duration-300 text-sm"
            >
              Se connecter
            </button>
