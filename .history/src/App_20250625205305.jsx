...
import DisponibilitesPage from './components/utilisateur/DisponibilitesPage.jsx';
import ListeProfessionnels from './components/utilisateur/ListeProfessionnels.jsx';
    ...
    return (
        <Router>
          ...
          <Route path="/auto-evaluation-basique" element={<AutoEvaluationBasique />} />
           <Route path="/" element={<ListeProfessionnels />} />
        <Route path="/disponibilites/:proId" element={<DisponibilitesPage />} />
