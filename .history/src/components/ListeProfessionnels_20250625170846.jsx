        ...
        <AnimatePresence mode="wait">
          {step === 1 && (
            ...
            >
              ...
              <div className="max-w-3xl mx-auto mb-16 grid grid-cols-1 md:grid-cols-2 gap-10 text-left">
                <div className="flex items-start gap-4">
                  <HeartPulse className="w-10 h-10 text-indigo-500 mt-1" />
                  <div>
                    <h3 className="text-2xl font-semibold text-indigo-700 mb-1">Psychologues</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-semibold text-indigo-700 mb-1">Psychiatres</h3>
                    <p className="text-gray-700 leading-relaxed max-w-sm">
              ...
              <button
                onClick={() => setStep(2)}
                className="relative inline-flex items-center justify-center gap-3 bg-indigo-700 hover:bg-indigo-800 text-white font-semibold rounded-full px-8 py-3 shadow-md hover:shadow-indigo-600 transition-all duration-300 active:scale-95"
          ...
          {step === 2 && (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <button
                  onClick={() => setStep(1)}
                  className="inline-flex items-center gap-2 text-indigo-700 hover:text-indigo-900 font-semibold transition active:scale-95 mt-4"
