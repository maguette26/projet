          ...
          {step === 2 && (
            ...
            >
              ...
              <div className="flex justify-center">
                <button
                  onClick={() => setStep(1)}
                  className="inline-flex items-center gap-2 text-indigo-700 hover:text-indigo-900 font-semibold transition active:scale-95 border border-indigo-700 rounded-full px-6 py-2 shadow-sm hover:shadow-md"
