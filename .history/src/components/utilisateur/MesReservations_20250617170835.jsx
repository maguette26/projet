...
import { Trash2, CalendarCheck, Clock, User, Euro, ChevronDown } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-indigo-50 p-4">
      ...
      >
        <select
          ...
          className="appearance-none cursor-pointer bg-white rounded-full px-6 py-3 text-indigo-700 font-semibold shadow-md
                     hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 transition w-48"
        ...
        {/* Icon Chevron */}
        <div className="pointer-events-none absolute right-4 top-3 text-indigo-500">
          <ChevronDown size={20} />
        </div>
      </motion.div>
