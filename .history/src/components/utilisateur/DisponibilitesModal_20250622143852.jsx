...
import { CalendarCheck, Clock, User2, X, CreditCard, Lock, CheckCircle, UserCheck } from 'lucide-react';
      ...
      <AnimatePresence>
        ...
        >
          ...
          >
            <button
              onClick={onClose}
              className="absolute top-5 right-5 p-1 rounded focus:outline-none focus:ring-0 hover:bg-transparent transition"
              aria-label="Fermer"
              style={{ color: '#4F46E5' }}
            >
              <X size={28} />
            ...
            {/* En-tête */}
            <div className="flex items-center gap-3 mb-8 justify-center text-indigo-700">
              <User2 size={34} />
                      ...
                      {sousCreneaux.map((heure, i) => {
                        ...
                        if (resvAPayer) {
                          return (
                            ...
                            >
                              <CreditCard size={20} />
                              <span className="text-sm">Payer {formatHeureAvecH(heure)}</span>
                            </button>
                          );
                        } else if (estReserve) {
                          return (
