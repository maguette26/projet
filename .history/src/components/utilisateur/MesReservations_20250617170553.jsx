...
const STATUTS = [
  '', // Pour afficher tous les statuts
  'EN_ATTENTE',
  'EN_ATTENTE_PAIEMENT',
  'PAYEE',
  'REFUSE',
...
const MesReservations = () => {
  ...
  const filteredReservations = reservations.filter(res => {
    ...
    const statutMatch = statutFilter === '' || res.statut === statutFilter;
    ...
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-xl mt-10">
      ...
      >
        <input
          ...
          className="w-full md:w-64 px-3 py-2 text-sm border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-500 transition block"
        ...
        <select
          ...
          className="w-full md:w-48 px-3 py-2 text-sm border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-500 transition"
