...
const MesReservations = () => {
  ...
  const handleAnnuler = async (id) => {
    ...
    try {
      ...
      setReservations(prev => prev.map(res => res.id === id ? { ...res, statut: 'ANNULEE' } : res));
    } catch (err) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-xl mt-10">
      {/* Titre + Filtre alignés horizontalement */}
      <div className="flex flex-col md:flex-row justify-between items-center mb-6">
        ...
        <motion.select
          ...
          className="mt-4 md:mt-0 bg-indigo-50 text-indigo-700 font-semibold rounded-full px-6 py-2 shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-indigo-400 transition"
