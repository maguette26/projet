...
const SuiviHumeur = ({ currentUser }) => {
  ...
  <section className="mb-12 bg-white p-6 rounded-3xl shadow-md max-w-xl mx-auto">
    <header className="flex items-center justify-between mb-4">
      ...
      <div className="flex flex-col gap-2">
        <button
          ...
          title="Modifier"
          className="flex items-center gap-1 text-indigo-600 hover:text-indigo-800 transition-colors text-sm px-3 py-1 rounded-lg border border-indigo-300 shadow-sm"
        >
        ...
        <button
          ...
          title="Supprimer"
          className="flex items-center gap-1 text-red-600 hover:text-red-800 transition-colors text-sm px-3 py-1 rounded-lg border border-red-300 shadow-sm"
        >
    ...
    <div className="flex items-start gap-6">
      ...
      {(() => {
        ...
        return MoodIcon ? <MoodIcon size={48} className={moodColor} /> : null;
      })()}

      {/* Texte humeur + note */}
      <div className="flex flex-col flex-1">
        <span className="text-2xl font-bold text-indigo-900">{humeurDuJour.etat}</span>
        <p className="mt-2 text-indigo-700 italic max-h-32 overflow-y-auto whitespace-pre-wrap scrollbar-thin scrollbar-thumb-indigo-400 scrollbar-track-indigo-100 p-2 bg-indigo-50 rounded-lg">
