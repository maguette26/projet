...
const MesReservations = () => {
  ...
  return (
    <div className="p-6">
      ...
      <motion.h2
        className="text-4xl font-extrabold text-indigo-700 mb-8 flex items-center gap-3"
        ...
        <ul className="space-y-6">
          <AnimatePresence>
            {filteredReservations.map((res) => (
              <motion.li
                key={res.id}
                className="bg-white p-6 rounded-2xl shadow-md border border-gray-200 flex flex-col md:flex-row justify-between items-start md:items-center gap-5 w-full md:w-[700px]"
