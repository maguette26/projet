...
const PaymentForm = ({ reservationId, onClose, refreshDisponibilites }) => {
  ...
  useEffect(() => {
    if (message?.type === 'success') {
      ...
      if (refreshDisponibilites) {
        refreshDisponibilites(); // 🔁 Rafraîchir les créneaux après paiement
      }
  ...
  }, [message, onClose, refreshDisponibilites]);
...
PaymentForm.propTypes = {
  ...
  refreshDisponibilites: PropTypes.func // facultatif, pour mise à jour après paiement
};
