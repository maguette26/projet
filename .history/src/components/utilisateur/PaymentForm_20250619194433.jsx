  ...
  const createPayment = async () => {
    try {
      ...
      if (
        ...
        error.response.data.includes('Veuillez attendre la validation de la réservation')
      ) {
        throw new Error("Veuillez attendre que la réservation soit validée par le professionnel avant de payer.");
      }
