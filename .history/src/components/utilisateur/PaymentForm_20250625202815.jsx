  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <button
        ...
        className="px-4 py-2 bg-indigo-600 text-white rounded w-full flex justify-center items-center gap-2 hover:bg-indigo-700 transition"
      >
        {loading ? (
          <>
...
const PaymentForm = ({ reservationId, onClose }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-lg p-6 max-w-md w-full shadow-lg relative max-h-screen overflow-y-auto mx-auto"
    ...
    >
      ...
      <div className="mb-4 flex justify-center gap-4">
        <button
          ...
          className={`px-4 py-2 rounded ${
            paymentMethod === 'stripe' ? 'bg-indigo-600 text-white' : 'bg-gray-200'
          }`}
        >
          Stripe
        </button>
        <button
          ...
          className={`px-4 py-2 rounded ${
            paymentMethod === 'paypal' ? 'bg-yellow-500 text-white' : 'bg-gray-200'
          }`}
        >
          PayPal
        </button>
      ...
      {paymentMethod === 'paypal' && (
        <button
          ...
          className="px-4 py-2 bg-yellow-500 text-white rounded w-full hover:bg-yellow-600 transition"
        >
          Payer avec PayPal
        </button>
      )}
