...
const PaymentForm = ({ reservationId, onClose }) => {
  ...
  onClick={onClose}
  aria-label="Fermer le formulaire de paiement"
  className="absolute top-3 right-3 w-8 h-8 flex items-center justify-center rounded-full bg-gray-200 hover:bg-gray-300 text-gray-600 hover:text-gray-900 transition-shadow shadow-md"
>
  <svg
