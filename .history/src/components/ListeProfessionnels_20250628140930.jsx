        ...
        <AnimatePresence mode="wait">
          {step === 1 && (
            ...
            >
              ...
              <h1 className="relative text-4xl font-extrabold text-indigo-900 mb-6 leading-tight tracking-wide drop-shadow-md">
                PsyConnect vous accueille
              </h1>
              <h2 className="relative text-lg md:text-xl italic text-indigo-700 mb-12 max-w-xl mx-auto drop-shadow-sm">
          ...
          {/* Le reste du code (liste des professionnels, modal, paiement, pied de page) reste inchangé */}
          {/* Tu peux garder la suite telle quelle comme dans ton code initial */}
        </AnimatePresence>
