...
import { User, CalendarDays, Filter, HeartPulse, Stethoscope, ArrowRightCircle } from 'lucide-react';
          ...
          {step === 1 && (
            ...
            >
              ...
              <p className="text-gray-800 text-lg mb-6">
                Trouvez un professionnel de santé mentale certifié, adapté à vos besoins.
              </p>
              <ul className="space-y-4 text-left text-gray-700 text-base max-w-md mx-auto">
                <li className="flex items-center gap-3">
                  <HeartPulse className="text-indigo-600 w-7 h-7" />
                  <span><strong>Psychologues :</strong> accompagnement par la parole, soutien émotionnel et thérapies adaptées.</span>
                </li>
                <li className="flex items-center gap-3">
                  <Stethoscope className="text-indigo-600 w-7 h-7" />
                  <span><strong>Psychiatres :</strong> médecins spécialisés pouvant prescrire traitements médicaux et diagnostics.</span>
                </li>
              </ul>
              <button
                onClick={() => setStep(2)}
                className="mt-10 px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-md font-semibold inline-flex items-center gap-2 shadow-md"
