      ...
      <main className="max-w-6xl mx-auto px-6 py-12 min-h-[80vh]">
        ...
        <AnimatePresence mode="wait">
          {step === 1 && (
            ...
            >
              <h2 className="text-4xl font-extrabold bg-gradient-to-r from-indigo-700 via-indigo-600 to-indigo-500 bg-clip-text text-transparent mb-8 leading-tight tracking-wide">
                Bienvenue sur <span className="font-extrabold">PsyConnect</span><br />
                Votre passerelle vers des professionnels de santé mentale qualifiés
              </h2>
              <p className="text-gray-800 text-lg mb-8 max-w-3xl mx-auto leading-relaxed text-justify">
                <em>
                  Sur <span className="font-semibold text-indigo-700">PsyConnect</span>, nous mettons à votre disposition un réseau d’experts en santé mentale : <strong>psychologues</strong> et <strong>psychiatres</strong> soigneusement sélectionnés pour leur expérience et leur engagement.
                </em>
              </p>

              <div className="space-y-10 max-w-3xl mx-auto text-left text-gray-700 text-base leading-relaxed">
                <div className="flex items-start gap-5">
                  <HeartPulse className="text-indigo-600 w-10 h-10 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="text-2xl font-semibold mb-2 text-indigo-700">Psychologues</h3>
                    <p className="text-gray-700 text-lg leading-relaxed">
                      Les psychologues vous accompagnent par l’écoute active et la parole. Spécialisés dans les approches thérapeutiques telles que la thérapie cognitivo-comportementale, la psychologie humaniste ou encore la psychanalyse, ils vous aident à surmonter vos difficultés émotionnelles et psychologiques. <strong>Ils ne prescrivent pas de médicaments</strong>, mais apportent un soutien précieux par la parole.
                    </p>
                  </div>
                </div>

                <div className="flex items-start gap-5">
                  <Stethoscope className="text-indigo-600 w-10 h-10 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="text-2xl font-semibold mb-2 text-indigo-700">Psychiatres</h3>
                    <p className="text-gray-700 text-lg leading-relaxed">
                      Les psychiatres sont des médecins spécialisés en santé mentale. Ils peuvent poser un diagnostic médical, prescrire des traitements médicamenteux, et proposer des prises en charge globales incluant psychothérapie et médication. Leur rôle est crucial notamment dans les troubles nécessitant un suivi médical approfondi.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <button
                onClick={() => setStep(2)}
                className="mt-12 px-10 py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-semibold inline-flex items-center gap-4 shadow-lg transition-transform active:scale-95"
          ...
          {step === 2 && (
            ...
            >
              ...
              {/* Bouton Retour repositionné et stylisé */}
              <div className="mt-8 flex justify-center">
                <button
                  onClick={() => setStep(1)}
                  className="inline-flex items-center gap-2 text-indigo-600 hover:text-indigo-800 font-semibold transition focus:outline-none"
