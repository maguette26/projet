...
const ListeProfessionnels = () => {
  ...
  const filteredPro = professionnels.filter(p => selectedSpecialite === 'all' || p.specialite === selectedSpecialite);
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-600 max-w-xl">
              Nous mettons à votre disposition des <strong>psychologues</strong> et des <strong>psychiatres</strong> qualifiés :
              <br />
              <span className="text-sm">
                🧠 Le <strong>psychologue</strong> vous accompagne par la parole et l'écoute. <br />
                💊 Le <strong>psychiatre</strong> est médecin et peut prescrire des traitements médicaux.
              </span>
              <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  🧠 Spécialité : <strong>{pro.specialite}</strong>
                </p>
              </div>
              <button
          ...
          {filteredPro.length === 0 && (
            <div className="col-span-full text-center py-12">
              <p className="text-lg text-gray-600 font-medium">😕 Aucun professionnel trouvé pour cette spécialité.</p>
