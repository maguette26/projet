  ...
  return (
    <div className="p-6">
      ...
      <div className="overflow-x-auto rounded-lg border border-gray-900 shadow">
        <table className="min-w-full bg-gray-50 table-fixed border-collapse border border-gray-900">
          <thead className="bg-indigo-600 text-white">
            <tr>
              <th className="border border-gray-900 px-4 py-3 text-xs font-semibold text-left uppercase tracking-wider w-24">Nom</th>
              <th className="border border-gray-900 px-4 py-3 text-xs font-semibold text-left uppercase tracking-wider w-24">Prénom</th>
              <th className="border border-gray-900 px-4 py-3 text-xs font-semibold text-left uppercase tracking-wider w-48">Email</th>
              <th className="border border-gray-900 px-4 py-3 text-xs font-semibold text-left uppercase tracking-wider w-28">Téléphone</th>
              <th className="border border-gray-900 px-4 py-3 text-xs font-semibold text-left uppercase tracking-wider w-32">Spécialité</th>
              <th className="border border-gray-900 px-4 py-3 text-xs font-semibold text-left uppercase tracking-wider w-24">Statut</th>
              <th className="border border-gray-900 px-4 py-3 text-center uppercase tracking-wider w-16">Document</th>
              <th className="border border-gray-900 px-4 py-3 text-center uppercase tracking-wider w-28">Actions</th>
            </tr>
          </thead>
          <tbody>
            {filteredProfessionnels.map(pro => (
              <tr key={pro.id}>
                <td className="border border-gray-900 px-4 py-3 text-sm font-medium text-gray-900 truncate">{pro.nom}</td>
                <td className="border border-gray-900 px-4 py-3 text-sm text-gray-900 truncate">{pro.prenom}</td>
                <td className="border border-gray-900 px-4 py-3 text-sm text-gray-700 truncate">{pro.email}</td>
                <td className="border border-gray-900 px-4 py-3 text-sm text-gray-700">{pro.telephone || 'N/A'}</td>
                <td className="border border-gray-900 px-4 py-3 text-sm text-gray-700 capitalize truncate">{pro.specialite || 'N/A'}</td>
                ...
                <td className="border border-gray-900 px-4 py-3 text-center space-x-2 whitespace-nowrap">
                  <button
