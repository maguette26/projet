...
const GestionUtilisateurs = () => {
    ...
    const rolesDisponibles = ['USER', 'ADMIN']; // Seuls les rôles pertinents pour cette vue
    ...
    return (
        <div className="container mt-5">
            ...
            {currentAdminEmail && <p>Connecté en tant que : <strong>{currentAdminEmail}</strong> (Rôle : {currentAdminRole})</p>}
