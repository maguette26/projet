...
function AdminFonctionnalites() {
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="bg-white p-4 rounded shadow mb-6">
        ...
        <div className="flex gap-4 flex-wrap">
          ...
          <button
            ...
            className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded disabled:opacity-50 disabled:cursor-not-allowed transition"
          >
      ...
      {!formVisible && (
        <div className="mb-4 text-right">
          <button
            ...
            className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded font-medium flex items-center justify-center gap-2 mx-auto md:mx-0"
          >
      ...
      {/* Formulaire */}
      {formVisible && (
        <form onSubmit={handleSubmit} className="bg-gray-50 p-6 rounded shadow mb-6 border border-gray-300">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex flex-col">
              <label className="mb-1 font-semibold text-gray-700">Nom</label>
              <input
            ...
            <div className="flex flex-col md:col-span-2">
              ...
              <textarea
                className="border border-gray-300 rounded px-3 py-2 resize-y min-h-[80px] focus:outline-none focus:ring-2 focus:ring-indigo-500"
                value={description}
                onChange={e => setDescription(e.target.value)}
              />
            </div>
            <div className="flex flex-col">
              <label className="mb-1 font-semibold text-gray-700">Lien fichier</label>
              <input
                className="border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                value={lienFichier}
            ...
            <div className="flex flex-col">
              <label className="mb-1 font-semibold text-gray-700">Catégorie</label>
              <input
                className="border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                value={categorie}
            ...
            <div className="flex items-center space-x-6 mt-4 md:mt-0">
              ...
              <label className="flex items-center space-x-2">
                <input
                  ...
                  className="h-5 w-5 text-indigo-600"
                />
                <span className="select-none">Premium</span>
              </label>
            </div>
          </div>
          ...
          <div className="mt-6 flex justify-end gap-4">
            <button
              type="submit"
              className="bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2 rounded shadow flex items-center transition"
            >
