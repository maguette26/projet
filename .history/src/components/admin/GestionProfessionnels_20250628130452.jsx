  ...
  return (
    <div className="p-6">
      ...
      <div className="overflow-x-auto rounded-lg border border-gray-900 shadow">
        <table className="min-w-full bg-gray-50 divide-y divide-gray-900 table-fixed border-collapse border border-gray-900">
          <thead className="bg-indigo-600 text-white">
            <tr>
              ...
              <th className="border border-gray-900 px-4 py-3 text-center uppercase tracking-wider w-20">Document</th>
