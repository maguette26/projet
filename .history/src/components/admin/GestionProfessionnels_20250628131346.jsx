...
const GestionProfessionnels = () => {
  ...
  return (
    <div className="p-6">         <h2 className="text-2xl font-bold mb-6 text-center text-indigo-800">Gestion des Professionnels</h2>
      ...
      <div className="overflow-x-auto rounded-lg border border-gray-300 shadow">
        <table className="min-w-full bg-gray-50 divide-y divide-gray-300 table-fixed">
          <thead className="bg-indigo-600 text-white divide-x divide-white">
            <tr>
              <th className="px-3 py-3 text-xs font-semibold text-left uppercase tracking-wider w-28">Nom</th>
              <th className="px-3 py-3 text-xs font-semibold text-left uppercase tracking-wider w-28">Prénom</th>
              <th className="px-3 py-3 text-xs font-semibold text-left uppercase tracking-wider w-52">Email</th>
              <th className="px-3 py-3 text-xs font-semibold text-left uppercase tracking-wider w-28">Téléphone</th>
              <th className="px-3 py-3 text-xs font-semibold text-left uppercase tracking-wider w-36">Spécialité</th>
              <th className="px-3 py-3 text-xs font-semibold text-left uppercase tracking-wider w-28">Statut</th>
              <th className="px-3 py-3 text-xs font-semibold text-center uppercase tracking-wider w-20">Document</th>
              <th className="px-3 py-3 text-xs font-semibold text-center uppercase tracking-wider w-28">Actions</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-300">
            {filteredProfessionnels.map(pro => (
              <tr key={pro.id} className="divide-x divide-gray-300">
                <td className="px-3 py-2 text-sm font-medium text-gray-700 truncate">{pro.nom}</td>
                <td className="px-3 py-2 text-sm text-gray-700 truncate">{pro.prenom}</td>
