...
const Chatbot = () => {
  ...
  const speak = (text) => {
    ...
    const voice = voices.find((v) => v.lang.includes("fr"));
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const botText = data.reply || "Je n’ai pas compris 😢";
  ...
  return (
    ...
    >
      ...
      {/* INPUT */}
      <div className="p-3 bg-white d-flex gap-2 align-items-center shadow-sm">

        <input
          ref={inputRef}
          className="form-control rounded-pill"
          placeholder={isRecording ? "🎤 J’écoute..." : "Écris ton message..."}
          value={input}
        ...
        <button
          ...
          style={{
            width: "45px",
            height: "45px",
            background: isRecording ? "#ff4d4d" : "#ffffff",
            border: "1px solid #ccc",
          }}
        >
          <Mic size={18} color={isRecording ? "#fff" : "#333"} />
        </button>
