...
const ListeProfessionnels = () => {
  ...
  <motion.section
    ...
    animate="animate"
    exit="exit"
    className="relative w-full min-h-[45vh] text-center px-8 py-8 bg-gradient-to-tr from-indigo-50 via-indigo-100 to-white overflow-hidden flex flex-col justify-center"
  >
    <div
      aria-hidden="true"
