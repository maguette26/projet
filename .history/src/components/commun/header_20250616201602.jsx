...
const Header = () => {
  ...
  // Applique la classe dark au body en fonction du mode
  useEffect(() => {
    if (darkMode) {
      ...
      <div className="max-w-7xl mx-auto px-6 py-3 flex justify-between items-center h-full">
        ...
        <nav className="flex items-center gap-6 text-sm font-semibold">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-1 rounded-full hover:bg-indigo-200 dark:hover:bg-indigo-600 transition text-sm font-semibold"
          >
            {darkMode ? (
              <>
                <span>🌞</span>
