...
const Header = () => {
  ...
  // Animation variants pour menu mobile
  const menuVariants = {
        ...
        <div className="hidden md:flex items-center gap-4">
          {currentRole ? (
            ...
            <>
              <Link
                to="/connexion"
                className="text-indigo-600 hover:text-indigo-400 font-semibold text-sm transition mr-4"
              >
                Connexion
              </Link>
              <Link
                to="/inscription"
                className="bg-indigo-600 text-white px-4 py-2 rounded-full hover:bg-indigo-700 transition text-sm font-semibold"
              >
                Inscription
              </Link>
            </>
