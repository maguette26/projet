      ...
      <header className="bg-white/95 backdrop-blur-md fixed top-0 w-full z-50 shadow-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-3 flex justify-between items-center h-[70px]">
          ...
          <div className="flex items-center gap-6">
            ...
            {/* UTILISATEUR : menu déroulant pour Espace Utilisateur / Nos Professionnels */}
            {currentRole === "UTILISATEUR" && (
              <div className="relative">
                ...
                >
                  <User className="w-4 h-4" /> Mon Espace <ChevronDown className="w-3 h-3" />
                </button>
                {userMenuOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 shadow-md rounded-md flex flex-col">
                    <Link
