        ...
        <AnimatePresence mode="wait">
          {step === 1 && (
            <motion.section
              ...
              animate="animate"
              exit="exit"
              className="relative w-full min-h-[55vh] text-center px-8 py-12 bg-gradient-to-r from-purple-600 via-indigo-700 to-indigo-900 overflow-hidden flex flex-col justify-center"
            >
              {/* Décors flous animés */}
              <div
                aria-hidden="true"
                className="absolute -top-28 -left-28 w-80 h-80 bg-purple-400 rounded-full opacity-30 filter blur-3xl animate-blob"
              />
              <div
                aria-hidden="true"
                className="absolute -bottom-32 -right-24 w-96 h-96 bg-indigo-800 rounded-full opacity-25 filter blur-3xl animate-blob animation-delay-4000"
              />

              <h1 className="relative text-4xl font-extrabold text-white mb-6 leading-snug tracking-tight drop-shadow-md">
                Bienvenue sur <span className="text-purple-300">PsyConnect</span>
              </h1>
              <h2 className="relative text-lg italic text-purple-200 mb-10 max-w-xl mx-auto drop-shadow-sm">
