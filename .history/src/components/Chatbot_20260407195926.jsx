...
const Chatbot = () => {
  const [messages, setMessages] = useState(() => {
    return (
      JSON.parse(localStorage.getItem("psybot_history")) || [
        {
          sender: "bot",
  ...
  useEffect(() => {
    localStorage.setItem("psybot_history", JSON.stringify(messages));
  }, [messages]);
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: "#f0f4f8", // fond doux et empathique
      }}
    >
      {/* Présentation simple PsyBot */}
      <div className="text-center my-4 d-flex justify-content-center align-items-center gap-2">
        <Bot size={28} className="text-primary" />
        <h4 className="fw-bold mb-0">PsyBot</h4><Bot size={28} className="text-primary" />
      </div>
