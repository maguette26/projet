          ...
          {step === 2 && (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <button
                  onClick={() => setStep(1)}
                  className="relative inline-flex items-center justify-center gap-4 bg-indigo-700 hover:bg-indigo-800 text-white font-semibold rounded-full px-110 py-5 shadow-lg shadow-indigo-500/40 hover:shadow-indigo-500/70 transition-all duration-300 active:scale-95"
