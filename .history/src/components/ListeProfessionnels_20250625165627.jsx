      ...
      <main className="max-w-6xl mx-auto px-6 py-12 min-h-[80vh]">
        ...
        <AnimatePresence mode="wait">
          {step === 1 && (
            ...
            >
              <h1 className="text-5xl font-extrabold text-indigo-900 mb-4 leading-tight tracking-tight">
                Bienvenue sur <span className="text-indigo-600">PsyConnect</span>
              </h1>
              <h2 className="text-xl italic text-indigo-700 mb-8 max-w-xl mx-auto">
              ...
              <div className="flex flex-col md:flex-row gap-8 max-w-3xl mx-auto mb-12">
                <div className="flex flex-col items-center bg-indigo-50 rounded-lg p-8 shadow-md flex-1">
                  <HeartPulse className="w-16 h-16 text-indigo-500 mb-4" />
              ...
              <button
                onClick={() => setStep(2)}
                className="inline-flex items-center justify-center gap-4 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-full px-12 py-4 shadow-lg transition-transform active:scale-95 mx-auto"
