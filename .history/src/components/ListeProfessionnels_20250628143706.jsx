      ...
      >
        <AnimatePresence mode="wait">
          {step === 1 && (
            ...
            <button
  onClick={() => setStep(2)}
  className="mt-14 relative inline-flex items-center justify-center gap-3 bg-indigo-700 hover:bg-indigo-800 text-white font-semibold rounded-full px-6 py-2 shadow-lg hover:shadow-indigo-600 transition-all duration-300 active:scale-95"
