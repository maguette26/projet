...
const ListeProfessionnels = () => {
  ...
  // Scroll en haut automatique quand on change l'étape (step)
  useEffect(() => {
    if (step === 2) {
        ...
        <AnimatePresence mode="wait">
          {step === 1 && (
            <motion.section
              ...
              animate="animate"
              exit="exit"
              className="relative w-full min-h-[90vh] text-center px-8 py-24 bg-gradient-to-tr from-indigo-50 via-indigo-100 to-white overflow-hidden flex flex-col justify-center"
            >
              {/* Décors flous animés */}
              <div
                aria-hidden="true"
              ...
              <h1 className="relative text-5xl font-extrabold text-indigo-900 mb-6 leading-tight tracking-tight drop-shadow-md">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
                {professionnelsFiltres.length === 0 ? (
                  ...
                  professionnelsFiltres.map((pro) => (
                    ...
                    <button
  onClick={() => setStep(2)}
  className="mt-14 relative inline-flex items-center justify-center gap-3 bg-indigo-700 hover:bg-indigo-800 text-white font-semibold rounded-md px-4 py-2 shadow-md hover:shadow-indigo-600 transition-all duration-300 active:scale-95"
  aria-label="Découvrir les professionnels"
>
  Découvrir les professionnels
